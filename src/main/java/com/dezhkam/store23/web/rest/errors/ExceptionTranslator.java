package com.dezhkam.store23.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.dezhkam.store23.service.EmailAlreadyUsedException ||
            ex instanceof com.dezhkam.store23.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.dezhkam.store23.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.dezhkam.store23");
    }
}
